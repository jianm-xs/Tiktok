...
type Video struct {
	...
	CommentCount  int64     `gorm:"-" json:"comment_count"`                          // 视频评论总数
	IsFavorite    bool      `gorm:"->is_favorite" json:"is_favorite"`                // 是否已点赞
	ISFollow      bool      `gorm:"->is_follow" json:"-"'`                           // 是否关注了作者，作为中转
